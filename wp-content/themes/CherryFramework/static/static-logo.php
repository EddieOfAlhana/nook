...
<div class="logo pull-left">
	...
	<?php } else { ?>
			<?php if(of_get_option('logo_url') == ''){ ?>
					<a href="<?php echo home_url(); ?>/" class="logo_h logo_h__img"><img src="http://suhanj.hardrockcoders.hu/img/ipalogo.png" alt="<?php bloginfo('name'); ?>" title="<?php bloginfo('description'); ?>"/></a>
