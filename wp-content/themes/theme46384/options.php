...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '13px', 'lineheight' => '25px', 'face' => 'Verdana, Geneva, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#858585'));
			...
			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '16px', 'lineheight' => '25px', 'face' => 'Verdana, Geneva, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#252424'));
								
			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '13px', 'lineheight' => '25px', 'face' => 'Verdana, Geneva, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#252424'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '20px', 'lineheight' => '25px', 'face' => 'Verdana, Geneva, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#343434'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '10px', 'lineheight' => '15px', 'face' => 'Verdana, Geneva, sans-serif', 'style' => 'bold', 'character'  => 'latin', 'color' => '#858585'));
